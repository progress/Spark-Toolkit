/*
 ...
 @license Apache-2.0
*/
(function(d,f,a,b){if(d&&f&&a&&"undefined"===typeof b.spark){var c=null,e=null,g=null,h=null,m={id:"",filterQuery:"",data:{},success:!1,error:!1},l=null;b.spark={version:"v3.2.1 (2017.10.03.100340)",field:{},form:{},grid:{},loader:{},nav:{},notify:{},strings:{},jsdoError:function(a){var c=((a.xhr||{}).jsdo||{getErrors:function(){return[]}}).getErrors(),e=[];d.each(c,function(b,a){switch(a.type){case -1:var c=null;if(a.responseText)try{c=JSON.parse(a.responseText||"")}catch(q){console.log("Error while parsing response: "+
