/*
 ...
 @license Apache-2.0
*/
(function(d,f,a,c){if(d&&f&&a&&"undefined"===typeof c.spark){var b=null,e=null,g=null,h=null,n={id:"",filterQuery:"",data:{},success:!1,error:!1},l=null;c.spark={version:"v4.2.0 (2017.12.12.044529)",field:{},form:{},grid:{},loader:{},nav:{},notify:{},strings:{},jsdoError:function(a){var b=((a.xhr||{}).jsdo||{getErrors:function(){return[]}}).getErrors(),e=[];d.each(b,function(c,a){switch(a.type){case -1:var b=null;if(a.responseText)try{b=JSON.parse(a.responseText||"")}catch(r){console.log("Error while parsing response: "+
